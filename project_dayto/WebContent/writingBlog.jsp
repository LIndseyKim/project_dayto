...
<html>
	...
	<body>
		...
		<form name="writing_blog-form" class="writing_blog-form"
			action="${pageContext.request.contextPath}/board/savePost.do"
			method="post">
			...
			<div style="margin: 0 auto; width: 1000px">
				...
				<h2 align="center">${user.userEmail}님의블로그 글 작성하기</h2>
				...
				<form method="post" enctype="multipart/form-data"
					...
					이미지선택 : <input type="file" name="image" /> <br /> <input
				...
				<p align="center">
					...
					<input type="submit" class="btn btn-large" type="button"
						value="입력완료">
